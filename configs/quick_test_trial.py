"""
Configuration for to error test the evaluation pipeline.
"""

from dataclasses import dataclass

@dataclass
class QuickTestTrialConfig:
    """Configuration for quick test training."""
...
trial_7stage_efficiency_config = QuickTestTrialConfig()