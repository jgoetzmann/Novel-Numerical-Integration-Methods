"""
Configuration for 4-stage Butcher table with 90% accuracy, 10% efficiency focus.
"""

from dataclasses import dataclass

@dataclass
class Trial4StageAccuracyConfig:
    """Configuration for 4-stage accuracy-focused training."""
    ...
    # Paths
    DATA_DIR: str = "data"
    RESULTS_DIR: str = "trials/trial_4stage_accuracy"
    TRIALS_DIR: str = "trials/trial_4stage_accuracy"
    LOGS_DIR: str = "logs"
    CHECKPOINTS_DIR: str = "trials/trial_4stage_accuracy/checkpoints"
...
trial_4stage_accuracy_config = Trial4StageAccuracyConfig()