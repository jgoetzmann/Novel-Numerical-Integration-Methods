"""
Configuration for 7-stage Butcher table with evolution learning and constraint rewards.
"""

from dataclasses import dataclass

@dataclass
class Trial7StageEvolutionConfig:
    """Configuration for 7-stage evolution-focused training with constraint rewards."""
    ...
    # Paths
    DATA_DIR: str = "data"
    RESULTS_DIR: str = "trials/trial_7stage_evolution"
    TRIALS_DIR: str = "trials/trial_7stage_evolution"
    LOGS_DIR: str = "logs"
    CHECKPOINTS_DIR: str = "trials/trial_7stage_evolution/checkpoints"
...
trial_7stage_evolution_config = Trial7StageEvolutionConfig()
