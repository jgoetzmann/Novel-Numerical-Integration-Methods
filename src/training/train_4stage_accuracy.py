"""
Training script for 4-stage Butcher table with 90% accuracy, 10% efficiency focus.
"""
...
from configs.trial_4stage_accuracy import trial_4stage_accuracy_config as config
...
def main_4stage_accuracy():
    """Main training function for 4-stage accuracy-focused model."""
    
    print("="*70)
    print("TRAINING: 4-STAGE BUTCHER TABLE - ACCURACY FOCUSED")
    print("="*70)
    ...
    if results:
        print("\n" + "="*70)
        print("4-STAGE ACCURACY-FOCUSED TRAINING RESULTS")
        print("="*70)
