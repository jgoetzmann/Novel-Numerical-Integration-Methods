"""
Training script for 4-stage Butcher table with evolution learning and constraint rewards.
"""
...
from configs.trial_4stage_evolution import trial_4stage_evolution_config as config
...
def main_4stage_evolution():
    """Main training function for 4-stage evolution-focused model."""
    
    print("="*70)
    print("TRAINING: 4-STAGE BUTCHER TABLE - EVOLUTION LEARNING")
    print("="*70)
    ...
    trial_id = f"4stage_evolution_{RANDOM_SEED}"
    ...
    if results:
        print("\n" + "="*70)
        print("4-STAGE EVOLUTION TRAINING RESULTS")
        print("="*70)
